...
def _legacy_registration(
    ...
    *,
    ...
    elif plugin_id == "galgame_plugin":
        relative_i18n_dir = "i18n/ui"
        kinds = {
    ...
    immutable_kinds = MappingProxyType(kinds)
    _validate_entry_ids(immutable_kinds, selected)
    return InstallPluginRegistration(
        plugin_id=plugin_id,
        install_kinds=immutable_kinds,
        ui_i18n_dir=_resolve_i18n_dir(config_path.parent, relative_i18n_dir),
